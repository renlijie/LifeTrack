...
class FixOverlay extends ItemizedOverlay<OverlayItem> {
  ...
  public FixOverlay(Cursor rows, HistoryMapActivity map, boolean drawMarkers) {
    ...
    while (true) {
      double lat = c.getDouble(c.getColumnIndex(Constants.COL_LAT));
      double lng = c.getDouble(c.getColumnIndex(Constants.COL_LNG));
      float acc = c.getFloat(c.getColumnIndex(Constants.COL_ACC));
  ...
  protected boolean onTap(int index) {
    ...
    new AlertDialog.Builder(map)
        .setTitle(CalendarUtils.dateToString(c) + " "
            ...
            new AlertDialog.Builder(map)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                  ...
                  public void onClick(DialogInterface dialog, int id) {
                    GeoFixDataStore geoFixDataStore = new GeoFixDataStore(map);

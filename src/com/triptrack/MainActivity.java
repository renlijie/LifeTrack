...
public final class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (((ToggleButton) v).isChecked()) {
                    ...
                    // Write the enabling status to SharedPreferences.
                    while (!editor.putBoolean(Constants.ENABLED, false)
                        .commit());
                    // Stop the alarm.
        ...
        final Button setIntervalButton =
            (Button) findViewById(R.id.set_interval);
                    ...
                    public void onClick(DialogInterface dialog,
                        ...
                        if (newIntervalMins == intervalMins) {
                            Toast.makeText(MainActivity.this,
                                ...
                                " " + Integer.toString(intervalMins) +
                                "mins.", Toast.LENGTH_SHORT)
                                .show();
                            return;
                        }
                        // Write the new interval to SharedPreferences.
                        while (!editor.putInt(Constants.INTERVAL_MINS,
                            newIntervalMins).commit());
                        Toast.makeText(MainActivity.this,
                            MainActivity.this
                            .getString(R.string.set_interval_changed) +
                            " " + Integer.toString(newIntervalMins) +
                            "mins.", Toast.LENGTH_SHORT).show();
                        // If the alarm is activated, restart it with
                        // the new interval.
                        if (settings.getBoolean(Constants.ENABLED,
                            false)) {
                            AlarmController.stopAlarm(MainActivity.this);
                            AlarmController.startAlarm(
                                MainActivity.this, newIntervalMins);
                        }
                    }
        ...
        final Handler mHandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                case Constants.HANDLER_PROGRESSBAR_SHOW: {
                    progressBar.show();
                    break;
                }
                case Constants.HANDLER_PROGRESSBAR_SETMAX: {
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            new Thread(new Runnable() {
                                public void run() {
                                    final FixDataStore fixDataStore =
                                        new FixDataStore(MainActivity.this);
                                    fixDataStore.open();
                                    fixDataStore.importFromFile(file, mHandler);
                                    fixDataStore.close();
                                    // Dismiss the progress bar on the UI thread.
                                    mHandler.sendMessage(Message.obtain(
                                        mHandler,
                                        Constants.HANDLER_PROGRESSBAR_DISMISS,
                                        0, 0, null));
                                }
                            }).start();
                        }
        ...
        exportButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                FixDataStore fixDataStore = new FixDataStore(
                    MainActivity.this);
                fixDataStore.open();
                ...
                .setPositiveButton("Yes",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            // Create a thread for exporting, although it's
                            // much faster than importing.
                            new Thread(new Runnable() {
                                public void run() {
                                    final FixDataStore fixDataStore =
                                        new FixDataStore(MainActivity.this);
                                    fixDataStore.open();
                                    fixDataStore.exportToFile(file, mHandler);
                                    fixDataStore.close();
                                    // Dismiss the progress bar on the UI
                                    // thread.
                                    mHandler.sendMessage(Message.obtain(
                                        mHandler,
                                        Constants.HANDLER_PROGRESSBAR_DISMISS,
        ...
        showButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.this.startActivity(
                    new Intent(MainActivity.this, HistoryMapActivity.class));
            }
        });
